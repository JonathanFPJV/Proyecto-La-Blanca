                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('productos.store') }}" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <x-text-input id="Codigo_producto" class="block mt-1 w-full" type="text" name="Codigo_producto" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="Nombre_producto" class="block mt-1 w-full" type="text" name="Nombre_producto" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="Precio" class="block mt-1 w-full" type="number" step="0.01" name="Precio" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="Talla" class="block mt-1 w-full" type="text" name="Talla" required />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="almacen_id" name="almacen_id" class="block mt-1 w-full" required>
